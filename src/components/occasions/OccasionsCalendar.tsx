              ...
              <div className="flex items-start gap-3 rounded-2xl bg-white/80 p-3 shadow-sm">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  {onAddDate ? (
                    <button
                      type="button"
                      className="mt-2 inline-flex items-center justify-center rounded-full bg-gp-evergreen px-4 py-2 text-xs font-semibold text-gp-cream transition hover:bg-gp-evergreen/90"
